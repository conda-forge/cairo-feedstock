...
make -f Makefile.win32 CFG=release ^
  ...
  CAIRO_LIBS='gdi32.lib msimg32.lib user32.lib %LIBRARY_LIB_CW%/libpng.lib %LIBRARY_LIB_CW%/zlib.lib %LIBRARY_LIB_CW%/freetype.lib %LIBRARY_LIB_CW%/fontconfig.lib %LIBRARY_LIB_CW%/xml2.lib'
